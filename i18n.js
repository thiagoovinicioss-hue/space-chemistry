...
(function () {
  ...
  var DICT = {
    pt: {
      ...
      'gabarito.title': 'Gabarito',
      'gabarito.fullTitle': 'GABARITO — EXERCÍCIOS',
      'gabarito.enter': 'Digite a senha para acessar o gabarito:',
      'gabarito.wrong': 'Senha incorreta!',
      'gabarito.confirm': 'Confirmar',
      'gabarito.cancel': 'Cancelar',
      'gabarito.close': 'Fechar',
      'gabarito.answer': 'Resposta',
      'gabarito.correct': 'Correto',
      'gabarito.select5': 'Selecione 5',
    ...
    en: {
      ...
      'gabarito.title': 'Answer Key',
      'gabarito.fullTitle': 'ANSWER KEY — EXERCISES',
      'gabarito.enter': 'Enter the password to access the answer key:',
      'gabarito.wrong': 'Wrong password!',
      'gabarito.confirm': 'Confirm',
      'gabarito.cancel': 'Cancel',
      'gabarito.close': 'Close',
      'gabarito.answer': 'Answer',
      'gabarito.correct': 'Correct',
      'gabarito.select5': 'Select 5',
    ...
    es: {
      ...
      'gabarito.title': 'Respuestas',
      'gabarito.fullTitle': 'RESPUESTAS — EJERCICIOS',
      'gabarito.enter': 'Escribe la contraseña para acceder a las respuestas:',
      'gabarito.wrong': '¡Contraseña incorrecta!',
      'gabarito.confirm': 'Confirmar',
      'gabarito.cancel': 'Cancelar',
      'gabarito.close': 'Cerrar',
      'gabarito.answer': 'Respuesta',
      'gabarito.correct': 'Correcto',
      'gabarito.select5': 'Selecciona 5',
